...
function MyApp({ Component, pageProps}) {
  ...
  let raceDate = new Date("3/4/2023")
  return (
    <div className="mx-auto w-10/12 sm:w-8/12 font-Poppins">
      <header className='flex w-full justify-between space-x-4'>
        ...
        {/* <a href="https://rtrt.me/ulink/HOUA/HOU-2023/tracker/R5ACUDJW/focus" className="hidden font-bold sm:flex place-self-center whitespace-nowrap" target="_blank" rel="noopener noreferrer">TRACK ME LIVE</a> */}
