...
export default function About() {
    return (
      <div>
        ...
        <main>
         <div>Hey! I'm a full time flight test engineer still trying to decide what I want to be when I grow up. Follow along as I share what I'm learning both as an engineer and an athlete!</div>
          <ul>
